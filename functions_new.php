...
>>>>>>> 4eab4101211c64f4f7b0d5c875d5a8d8a0ed1b91
    register_nav_menus(
        array(
...
function add_portfolio_manager_role() {
    ...
    $caps['edit_portfolio'] = true;
    $caps['read_portfolio'] = true;
    $caps['delete_portfolio'] = true;
    $caps['edit_portfolios'] = true;
    $caps['publish_portfolios'] = true;
    $caps['edit_published_portfolios'] = true;
    $caps['delete_published_portfolios'] = true;
    
    $caps['edit_others_portfolios'] = true;
    add_role('portfolio_manager', 'Менеджер портфолио', $caps);
}

function remove_portfolio_manager_role() {
    if (get_role('portfolio_manager')) {
        remove_role('portfolio_manager');
    }
}

add_action('after_switch_theme', 'add_portfolio_manager_role');
add_action('switch_theme', 'remove_portfolio_manager_role');
=======
>>>>>>> 4eab4101211c64f4f7b0d5c875d5a8d8a0ed1b91
